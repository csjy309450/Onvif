...
#ifdef HAVE_USING_GLOG

#include "Logger.h"

#endif // HAVE_USING_GLOG
...
*/
int
soap_wsdd_Hello(struct soap *soap, soap_wsdd_mode mode, const char *endpoint, const char *MessageID,
...
*/
int
soap_wsdd_Bye(struct soap *soap, soap_wsdd_mode mode, const char *endpoint, const char *MessageID,
...
*/
int
soap_wsdd_Probe(struct soap *soap, soap_wsdd_mode mode, soap_wsdd_to to, const char *endpoint, const char *MessageID,
                const char *ReplyTo, const char *Types, const char *Scopes, const char *MatchBy) {
...
*/
int
soap_wsdd_Resolve(struct soap *soap, soap_wsdd_mode mode, soap_wsdd_to to, const char *endpoint, const char *MessageID,
...
*/
int
soap_wsdd_add_ProbeMatch(struct soap *soap, struct wsdd__ProbeMatchesType *matches, const char *EndpointReference,
  ...
  /* yes we do */
  if (n) {
    struct wsdd__ProbeMatchType *tmp = (struct wsdd__ProbeMatchType *) soap_malloc(soap, n *
...
*/
int
soap_wsdd_ProbeMatches(struct soap *soap, const char *endpoint, const char *MessageID, const char *RelatesTo,
...
*/
int
soap_wsdd_ResolveMatches(struct soap *soap, const char *endpoint, const char *MessageID, const char *RelatesTo,
...
static int
soap_wsdd_http(struct soap *soap, const char *endpoint, const char *host, int port, const char *path,
